<div class="wrapper container-fluid">
	...
	{!! Form::open(['url'=>route('pagesEdit',['page'=>$data['id']]), 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
    ...
    <div class="form-group">
		...
		<div class="col-xs-8">
			{!! Html::image('assets/img/'.$data['images'],'',['class'=>'col-xs-4 img-circle']) !!}
    ...
    <div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::file('images',['class'=>'filestyle','data-buttonText'=>'Выберите изображение','data-buttonName'=>'btn-primary','placeholder'=>'Файла нет']) !!} 
		</div>
    </div>
