...
<section class="page_section team" id="team"><!--main-section team-start-->
	...
	@foreach($peoples as $k => $item)
		...
		<div class="team_box wow fadeInDown delay-0{{($k*3)}}s">
			...
			{{ Html::image('assets/img/'.$item->image,$item->name) }}
		</div>
		<h3 class="wow fadeInDown delay-0{{($k*3)}}s">{{$item->name}}</h3>
		<span class="wow fadeInDown delay-0{{($k*3)}}s">{{ $item->position }}</span>
		<p class="wow fadeInDown delay-0{{($k*3)}}s">{{ $item->bio }}</p>
		</div>
	@endforeach
	</div>
	</div>
				...
				<div class="col-lg-4 wow fadeInLeft">
					...
					<ul class="social_links">
						<li class="twitter animated bounceIn wow delay-02s">
							<a href="javascript:void(0)"> <i class="fa fa-twitter"></i>
							</a>
						</li>
						<li class="facebook animated bounceIn wow delay-03s">
							<a href="javascript:void(0)"> <i class="fa fa-facebook"></i>
							</a>
						</li>
